...
`tools/export_profile_review_sheet.py` 可将 `work/profile_drafts/` 导出为 `work/profile_review.csv`，供人工补录底座尺寸、编队信息并逐条标记审核决定；导出表只含结构化数值和来源页码。
