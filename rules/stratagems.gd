...
const GRANTABLE_ABILITIES := ["fall_back_and_shoot", "fall_back_and_charge", "advance_and_charge", "shoot_after_advance", "fights_first", "reroll_hit", "reroll_hit_ones", "reroll_wound", "reroll_wound_ones", "stealth", "lone_operator", "reroll_save", "reroll_save_ones", "invulnerable_4", "invulnerable_5", "objective_control_plus_1"]
