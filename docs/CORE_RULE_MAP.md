...
| 移动、部署、连续性、交战状态 | `rules/movement.gd`、`rules/unit_validation.gd`、`rules/unit_movement.gd`、`rules/deployment.gd`、`rules/reserves.gd`、`rules/engagement.gd`、`rules/replay.gd` | 已加入多模型连续性、部署区、深入打击预备队、底座边缘接战和可回放前进状态 |
