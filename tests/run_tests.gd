...
func run() -> void:
	...
	check(WeaponRules.canonical_id("熱熔2") == "melta_2" and WeaponRules.canonical_id("連擊1") == "rapid_fire_1" and WeaponRules.canonical_id("無視掩體") == "ignores_cover", "weapon aliases normalize traditional Chinese")
